...
// treePath represents a path taken in the tree to get to a specific node, as a
// stack of nodes. c is implicitly on the top of the path stack. For every node
// c at stack[j], its parent is stack[j-1].parent and c is in that parent's
// children at index stack[j-1].childIndex
